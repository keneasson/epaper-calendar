/*
 * Bitmap Font for Display Simulation
 * 8x8 pixel font covering ASCII 32-126
 */
...
inline const uint8_t* font_get_char(char c) {
    if (c < 32 || c > 126) {
        return FONT_8X8[0];  // Return space for invalid chars
    }
